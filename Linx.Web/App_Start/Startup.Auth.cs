...
namespace Linx.Web
{
    public partial class Startup
    {
        ...
        {
            //Microsoft.Owin.Security.OAuth.OAuthAuthorizationServerOptions authServerOptions =
            ...
            //        AccessTokenFormat = new CustomJwtFormat("http://localhost:51346/")
            //    };
            ...
            //var issuer = "http://localhost:51346/";
            ...
            ////                           select new SymmetricKeyIssuerSecurityTokenProvider(issuer, 
            ////                           TextEncodings.Base64Url.Decode(x.Value.SecretKey))).ToArray();
